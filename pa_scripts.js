...
//Quote
const isInsideVeContentColor=e=>e.closest(".ve-content.color")!==null;const expandQuotes=e=>{if(!isInsideVeContentColor(e)&&!e.querySelector(".quotebtn")&&e.scrollHeight>170){e.style.maxHeight="170px",e.style.overflow="hidden",e.style.transition="max-height 0.382s ease-in-out";const t=document.createElement("div");t.className="quotebtn";const o=document.createElement("button");o.innerHTML="Show More...",o.type="button",o.onclick=()=>{const t=o.closest(".quote");t.style.maxHeight=t.scrollHeight+"px",setTimeout(()=>{t.style.maxHeight="none",t.style.overflow="visible",t.parentElement.remove()},382)};t.appendChild(o),e.appendChild(t)}};document.querySelectorAll(".color .quote").forEach(expandQuotes);const quoteObserver=new MutationObserver(t=>{t.forEach(t=>{t.addedNodes.forEach(t=>{if(t.nodeType===Node.ELEMENT_NODE){t.matches(".quote")&&expandQuotes(t),t.querySelectorAll(".quote").forEach(e=>{e.querySelector(".quotebtn")||expandQuotes(e)})}})})});quoteObserver.observe(document.body,{childList:!0,subtree:!0});document.querySelectorAll(".color .quote_top").forEach(modifyQuoteTop);const quoteTopObserver=new MutationObserver(t=>{t.forEach(t=>{t.addedNodes.forEach(t=>{if(t.nodeType===Node.ELEMENT_NODE)t.querySelectorAll(".quote_top").forEach(modifyQuoteTop)})})});const modifyQuoteTop=e=>{if(isInsideVeContentColor(e))return;const t=e.textContent,o=e.querySelector("a");if(t.includes("@")){const n=t.replace(/(.*)\s*\(([^@]+)@[^)]+\)\s*/,"$2 said:");e.innerHTML=n,e.style.color="var(--mdcol)",o&&(e.appendChild(o),o.style.color="var(--mdcol)")}else{const t=e.querySelector(".quote_top b");t&&(t.style.opacity=1)}};quoteTopObserver.observe(document.body,{childList:!0,subtree:!0});
//Youtube lite
