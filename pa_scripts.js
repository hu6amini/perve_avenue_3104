...
//Emojione function processEmojisInColorClass(){document.querySelectorAll('.color').forEach(e=>{e.innerHTML=emojione.toImage(e.innerHTML)})}processEmojisInColorClass();
//Tooltips
