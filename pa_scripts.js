...
//Quote
$(document).ready((function(){function applyReadmore(e){$(e).find(".quote").not(".ve-content .quote").readmore({speed:150,collapsedHeight:170,moreLink:'<a href="#">Show More...</a>',lessLink:"",afterToggle:function(e,o,r){r&&$(e).remove()}})}applyReadmore($(".color"));new MutationObserver((e=>{e.forEach((e=>{e.addedNodes.forEach((e=>{$(e).is(".color")?applyReadmore($(e)):$(e).find(".color").length&&applyReadmore($(e).find(".color"))}))}))})).observe(document.body,{childList:!0,subtree:!0})}));
//Youtube lite
