...
//Quote
function isInsideVeContentColor(e){return null!==e.closest(".ve-content.color")}function debounce(e,o){let n;return function(...s){clearTimeout(n),n=setTimeout((()=>e.apply(this,s)),o)}}function expandQuotes(e){if(!isInsideVeContentColor(e)){const t=()=>{const o=e.querySelector(".quotebtn button");if(!o&&e.scrollHeight>170){e.style.maxHeight="170px",e.style.overflow="hidden";const o=document.createElement("div");o.className="quotebtn";const n=document.createElement("button");n.textContent="Show More...",o.appendChild(n),e.appendChild(o),n.addEventListener("click",(n=>{n.preventDefault(),n.stopPropagation(),e.style.transition="max-height 0.382s ease-in-out",e.style.maxHeight=e.scrollHeight+"px",o.style.display="none",setTimeout((()=>{e.style.maxHeight="none"}),382)}))}else o&&e.scrollHeight<=170&&(o.parentNode.remove(),e.style.maxHeight="none")};t(),resizeObserver.observe(e);const o=e.querySelector(".spoiler .code_top a");o&&o.addEventListener("click",(()=>{e.style.maxHeight="none",resizeObserver.unobserve(e)}))}}const resizeObserver=new ResizeObserver(debounce((e=>{e.forEach((e=>expandQuotes(e.target)))}),100)),quotes=document.querySelectorAll(".post .quote,#loading .quote,.summary .list li .quote,#search .color .quote");for(let e=0;e<quotes.length;e++)expandQuotes(quotes[e]);const quoteObserver=new MutationObserver((e=>{for(const o of e)for(const e of o.addedNodes)e.nodeType===Node.ELEMENT_NODE&&(e.matches(".quote")?expandQuotes(e):e.querySelectorAll(".quote").forEach((e=>expandQuotes(e))))}));function modifyQuoteTop(e){if(!isInsideVeContentColor(e)){const o=e.textContent,n=e.querySelector("a");if(o.includes("@")){const s=o.replace(/(.*)\s*\(([^@]+)@[^)]+\)\s*/,"$2 said:");e.innerHTML=s,e.style.color="var(--mdcol)",n&&(e.appendChild(n),n.style.color="var(--mdcol)")}else{const o=e.querySelector(".quote_top b");o&&(o.style.opacity=1)}}}quoteObserver.observe(document.body,{childList:!0,subtree:!0});const quoteTops=document.querySelectorAll(".post .quote_top,#loading .quote_top,.summary .list li .quote_top,#search .color .quote_top");for(let e=0;e<quoteTops.length;e++)modifyQuoteTop(quoteTops[e]);const quoteTopObserver=new MutationObserver((e=>{for(const o of e)for(const e of o.addedNodes)e.nodeType===Node.ELEMENT_NODE&&e.querySelectorAll(".quote_top").forEach((e=>modifyQuoteTop(e)))}));quoteTopObserver.observe(document.body,{childList:!0,subtree:!0}),document.addEventListener("click",(function(e){"button"===e.target.tagName.toLowerCase()&&(e.preventDefault(),e.stopPropagation())}));
//Youtube lite
