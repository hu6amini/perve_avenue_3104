...
const p=document.getElementById("Post");if(p){const placehObserver=new MutationObserver(()=>{"inline-block"===window.getComputedStyle(p).display?p.setAttribute("placeholder","Write your reply..."):p.removeAttribute("placeholder")});placehObserver.observe(p,{attributes:!0,attributeFilter:["style"]}),"inline-block"===window.getComputedStyle(p).display&&p.setAttribute("placeholder","Write your reply...")}
//Textarea Autogrow 
