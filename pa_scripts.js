...
//Quote
function isInsideVeContentColor(e) {
    return e.closest(".ve-content.color") !== null;
}

function expandQuotes(e) {
    if (!isInsideVeContentColor(e) && !e.querySelector(".quotebtn") && e.scrollHeight > 170) {
        e.style.maxHeight = "170px";
        e.style.overflow = "hidden";
        e.style.transition = "max-height 0.382s ease-in-out";

        const o = document.createElement("div");
        o.className = "quotebtn";
