...
document.querySelectorAll("img:not(.lazyload):not(.slick_carousel img):not([data-lazy-replaced])").forEach(function(e){var t=e.getAttribute("src");if(t){e.setAttribute("data-src",t);e.removeAttribute("src");e.classList.add("lazyload");e.setAttribute("loading","lazy");e.setAttribute("decoding","async");var n=document.createElement("noscript");n.innerHTML='<img src="'+t+'"'+(e.hasAttribute("alt")?' alt="'+e.alt+'"':"")+' decoding="async">';e.parentNode.insertBefore(n,e);e.setAttribute("data-lazy-replaced","true")}});
//Emojione 
