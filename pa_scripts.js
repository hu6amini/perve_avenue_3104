...
//Light gallery 
const processImages=()=>{document.querySelectorAll(".post .color,.summary .list li .color.Item").forEach(t=>{t.querySelectorAll('img:not(.emojione):not(.signature img):not([src^="https://img.forumfree.net/html/emoticons/new"]):not([src^="https://img.forumfree.net/html/mime_types"])').forEach(e=>{if(!(e.alt&&e.alt.startsWith(":")||"a"===e.parentNode.tagName.toLowerCase()&&e.src.startsWith("https://www.google.com/s2/favicons"))){const t=e.parentNode;if("a"===t.tagName.toLowerCase()){t.href===e.src&&t.setAttribute("data-lightbox","gallery")}else{const a=document.createElement("a");a.href=e.src||e.getAttribute("data-src"),a.setAttribute("data-lightbox","gallery"),t.insertBefore(a,e),a.appendChild(e)}}});lightGallery(t,{selector:'a[data-lightbox="gallery"]'})})};processImages();const lightgalObserver=new MutationObserver(()=>{processImages()});lightgalObserver.observe(document.body,{childList:!0,subtree:!0});
//Slick carousel 
