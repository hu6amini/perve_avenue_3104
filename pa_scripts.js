...
//Emojione 
function processEmojisInColorClass(){document.querySelectorAll('.post .color,#loading .color').forEach(e=>{e.innerHTML=emojione.toImage(e.innerHTML)})}processEmojisInColorClass();
//Tooltips
