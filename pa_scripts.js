...
//Image generator
function createCustomDialog(){var e=document.querySelector(".imgen-backdrop"),t=document.querySelector(".imgen"),n=document.querySelector(".imgen-alert");if(t){t.style.display="block",e.style.display="block",n.style.display="none";var a=t.querySelector("input");a&&a.focus()}else{var e=document.createElement("div");e.className="imgen",e.style.zIndex=9999;var t=document.createElement("div");t.className="imgen-backdrop",t.addEventListener("click",function(){e.style.display="none",t.style.display="none",document.querySelector(".imgen-alert").style.display="none",document.querySelector(".imgen input").value=""});var n=document.createElement("div");n.className="header",n.innerHTML='<i class="fa-regular fa-image"></i> Generate Image Thumbnail',e.appendChild(n);var a=document.createElement("div");a.className="imgen-alert",a.innerHTML='<i class="fa-regular fa-circle-exclamation"></i> Please enter a valid URL',e.appendChild(a),a.style.display="none";var l=document.createElement("input");l.type="text",l.placeholder="Insert image link...",l.setAttribute("aria-label","Image URL"),e.appendChild(l);var c=document.createElement("button");c.className="codebuttons",c.textContent="INSERT",c.addEventListener("click",function(){var n=l.value;validateImageURL(n,function(t){t?(insertAtCursor('<img src="'+n+'">'),triggerInputEvent(),e.style.display="none",t.style.display="none",l.value=""):a.style.display="block"})}),e.appendChild(c),c.setAttribute("aria-label","Insert"),l.addEventListener("click",function(){l.select()}),document.body.appendChild(t),document.body.appendChild(e),e.style.display="block",l.focus()}}function insertAtCursor(e){var t=document.querySelector("textarea#Post");if(t){var n=t.selectionStart,a=t.selectionEnd,l=t.value.substring(0,n),c=t.value.substring(a);t.value=l+e+c;var i=n+e.length;t.setSelectionRange(i,i),t.focus()}}function triggerInputEvent(){var e=document.querySelector("textarea#Post");if(e){var t=new Event("input",{bubbles:!0,cancelable:!0});e.dispatchEvent(t)}}function validateImageURL(e,t){var n=new Image;n.src=e,n.onload=function(){t(!0)},n.onerror=function(){t(!1)}}function tag_image(){createCustomDialog()}if(document.URL.indexOf("?act=Post")!==-1||document.URL.indexOf("?t=")!==-1);else{var e=document.querySelector('.codebuttons[value*="IMG"]');e&&e.addEventListener("click",tag_image)}
//Link generator
