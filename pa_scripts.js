...
//Avatar pack
document.addEventListener("DOMContentLoaded",function(){!function(){const e=["#ff7770","#ff6b6b","#ff5154","#ffcb69","#fdc26d","#ffa96c","#ff9f1c","#ff8f5c","#9ce37d","#74c365","#16c172","#3ab795","#4ecdc4","#2dc7ff","#0eb1d2","#009bf5","#a3bcf9","#9b9ece","#9792e3","#8075ff","#b455b0","#a755c2","#a5acb5","#889696"],t=["https://res.cloudinary.com/dbdf6gwgo/image/upload/v1674337715/forum/Avatar/default_avatar_zpw3zz.svg","https://res.cloudinary.com/dbdf6gwgo/image/upload/v1676109015/forum/Avatar/robot_snynw7.svg","https://img.forumfree.net/style_images/default_avatar.png","https://img.forumfree.net/style_images/default_avatar_bot.png"],s=new Map,o=new WeakMap,a=new WeakMap,r=new Worker("https://cdn.jsdelivr.net/gh/hu6amini/perve_avenue_2714@main/worker.js");function c(t,s,o,a,l){const c=document.createElement("a");if(c.className="avatar",c.href=o,t&&!e.includes(t.src)){const e=document.createElement("img");return e.src=t.src,e.loading="lazy",e.decoding="async",e.onerror=function(){const e=l||s.textContent.trim(),o=i(e);c.innerHTML="",c.appendChild(o)},c.appendChild(e),c}else{const e=l||s.textContent.trim(),t=i(e);return c.appendChild(t),c}}function i(t){const s=document.createElement("span");return s.className="avatar",s.textContent=(e=>{const t=e.match(/[A-Za-z]/);return t?t[0].toUpperCase():e.match(/[0-9]/)?.[0]||e.match(/[^A-Za-z0-9]/)?.[0]||"?"})(t),s.style.backgroundColor=e[Math.min(Math.floor(t.length/Math.ceil(1/e.length)),e.length-1)],s}function n(e,t,o){const a=e.href;if(s.has(a)){const e=s.get(a);return e.failed?void u(c(null,t,a),o):void u(c(e.profileAvatarImg,t,a,e.fullName),o)}r.postMessage(a),r.addEventListener("message",function(e){if(e.data.url===a){const r=e.data;if(r.failed)return s.set(a,{failed:!0}),void u(c(null,t,a),o);s.set(a,{profileAvatarImg:r.imgEl,fullName:r.name,failed:!1}),u(c(r.imgEl,t,a,r.name),o)}})}function u(e,t){const s=o.get(t)||{summary:t.closest(".summary .list li"),popup:t.closest(".popup.pop_points ol.users li"),boardStats:t.closest(".stats .zz .users li"),sideStats:t.closest(".side_stats.sidebox .users li"),tagObject:t.closest("#tagObject li"),emojiPostAuthor:t.closest(".st-emoji-epost-author"),sendMainBg:t.closest(".send .mainbg")};o.set(t,s);const{summary:a,popup:r,boardStats:i,sideStats:n,tagObject:u,emojiPostAuthor:l,sendMainBg:d}=s;if(a){const s=t.querySelector(".left.Sub.Item");if(s){const t=document.createElement("div");t.className="summary_details";const o=s.querySelector(".nick");o&&t.appendChild(o),t.appendChild(e),s.insertBefore(t,s.firstChild)}}else if(r&&document.body.matches("#topic, #search"))!t.querySelector(".avatar")&&t.insertBefore(e,t.firstChild);else if(i&&document.body.matches("#board"))!t.querySelector(".avatar")&&t.insertBefore(e,t.firstChild);else if(n&&document.body.matches("#blog"))!t.querySelector(".avatar")&&t.insertBefore(e,t.firstChild);else if(u&&document.body.matches("#board"))!t.querySelector(".avatar")&&t.insertBefore(e,t.firstChild);else if(l&&document.body.matches("#topic"))(!t.previousElementSibling||!t.previousElementSibling.classList.contains("avatar"))&&t.parentNode.insertBefore(e,t);else if(d||t.closest(".send")){const s=document.createElement("div");s.className="send_av",s.appendChild(e);const n=(d||t.closest(".send")).querySelector(".send_av");n||t.previousElementSibling&&t.previousElementSibling.classList.contains("send_av")||t.parentNode.insertBefore(s,t)}else(!t.previousElementSibling||!t.previousElementSibling.classList.contains("avatar"))&&t.parentNode.insertBefore(e,t)}async function l(e){await Promise.all((Array.isArray(e)?e:[e]).map((async e=>{const t=a.get(e)?.userLink||e.querySelector('a[href*="act=Profile&MID="]');t&&(a.set(e,{userLink:t}),n(t,t,e))})))}function d(){let e=a.get(document)?.userLink||document.querySelector('.menuwrap .left .menu:first-child a[href*="act=Profile&MID="]'),t=a.get(document)?.sendMainBg||document.querySelector(".send .mainbg");if(e&&t){const s=e.href.match(/MID=\d+/)?.[0];if(s){const o=document.querySelector(".onln .users a[href*='"+s+"']");o&&(e=o)}a.set(document,{userLink:e,sendMainBg:t}),n(e,e,t)}}new MutationObserver(e=>{e.forEach(e=>{"childList"===e.type&&e.addedNodes.length>0&&document.querySelector(".send .mainbg")&&d()})}).observe(document.body,{childList:!0,subtree:!0}),new MutationObserver(e=>{const t=[{selector:".big_list .zz .who",bodyMatches:"#board, #forum, #blog, #search"},{selector:".popup.pop_points ol.users li",bodyMatches:"#topic, #search"},{selector:".st-emoji-epost-author",bodyMatches:"#topic"},{selector:".stats .zz .users li",bodyMatches:"#board"},{selector:".side_stats.sidebox .users li",bodyMatches:"#blog"},{selector:"#tagObject li",bodyMatches:"#board"},{selector:".summary .list li",bodyMatches:"#send"},{selector:".post .details",bodyMatches:"#topic, #send"}];e.forEach(e=>{const s=Array.from(e.addedNodes).filter(e=>1===e.nodeType);if(s.length>0){const e=new Set;t.forEach(({selector:t,bodyMatches:o})=>{document.body.matches(o)&&s.forEach(s=>{s.matches(t)?e.add(s):s.querySelectorAll(t).forEach(t=>e.add(t))})}),e.size>0&&l(Array.from(e))}})}).observe(document.body,{childList:!0,subtree:!0}),d()}()});
//Emojione 
...
//Timeago 
$('.post .when, .big_list .when, .summary .when, body#board .side_topics .when, body#board .lastarticles .topic .when, .st-emoji-notice-time').each(function() {
    var dateText = $(this).text().trim();  // Get the text content and trim extra spaces
    // Handle cases where the date might be prefixed with "on:"
    dateText = dateText.replace(/^on:\s*/, '').trim();
    var formattedDate;
