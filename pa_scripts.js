...
//Emojione 
function processEmojisInColorClass(){document.querySelectorAll(".post .color,#loading .color,.summary .color,.st-emoji-epost-content.color").forEach(e=>{e.innerHTML=emojione.toImage(e.innerHTML)})}processEmojisInColorClass();const emojiObserver=new MutationObserver(e=>{e.forEach(e=>{e.addedNodes.forEach(e=>{1===e.nodeType&&(e.matches(".post .color,#loading .color,.summary .color,.st-emoji-epost-content.color")?e.innerHTML=emojione.toImage(e.innerHTML):e.querySelectorAll(".post .color,#loading .color,.summary .color,.st-emoji-epost-content.color").forEach(e=>{e.innerHTML=emojione.toImage(e.innerHTML)}))})})});emojiObserver.observe(document.body,{childList:!0,subtree:!0});
//Tooltips
