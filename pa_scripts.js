...
$(document).ready(function() {
    ...
    $('.post .when span,.summary .when span,#search tr.title2.top .when span').each(function() {
        $(this).remove();  // Remove the inner span
    });

    // Select all the '.post .when' elements
    $('.post .when, .big_list .when,.summary .when,#search tr.title2.top .when').each(function() {
